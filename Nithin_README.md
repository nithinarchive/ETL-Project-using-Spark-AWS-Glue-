 ## Hello everyone. Welcome to my Data Engineering (ETL) project. We will talk about ETL (Extraction, Transformation and Loading) job using Apache Spark with AWS Glue and AWS RedShift.
